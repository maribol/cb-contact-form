...
wp_enqueue_style('cb-contact-form-css', plugin_dir_url(__FILE__) . 'cb-contact-form.css', array(), '1.0');
wp_enqueue_script('cb-contact-form-js', plugin_dir_url(__FILE__) . 'cb-contact-form.js', array(), '1.0', true);